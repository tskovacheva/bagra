...
export const VOCABULARY = [
  ...
  V('fabric_structure', 'plain',  'платно',   'plain weave', 1),
  V('fabric_structure', 'crepe',  'креп',     'crepe', 2),
  V('fabric_structure', 'jersey', 'трико',    'jersey', 3),
  V('fabric_structure', 'twill',  'кепър',    'twill', 4),
  V('fabric_structure', 'gauze',  'марля',    'gauze', 5),
  V('fabric_structure', 'velvet', 'кадифе',   'velvet', 6),
